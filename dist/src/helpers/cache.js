...
function updateCacheStatsUI() {
    ...
    const cachedCount = window.tweetCache.size;
    const wlCount = window.blacklistedHandles ? window.blacklistedHandles.length : 0;
...
window.updateCacheStatsUI = updateCacheStatsUI;